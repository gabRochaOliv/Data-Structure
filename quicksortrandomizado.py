...
file_path = 'QuickSortRandomizadoIteracoesCasoMedio.txt'
try:
...
plt.title('Número Médio de Iterações para QuickSort Randomizado')
plt.xlabel('Tamanho do Array')
plt.ylabel('Número de Iterações')
plt.grid(True)
plt.xticks(array_sizes)
plt.savefig('quicksort_randomizado_iterations.png')
plt.show()
